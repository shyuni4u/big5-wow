    ...
    talents: [
      {
        ...
        desc:
          '강인한 곰으로 변신하여 피해를 흡수하고 아군을 보호합니다. 선호 무기: 지팡이, 장창'
      },
      {
        name: 'feral',
        position: 'dealer',
    ...
    talents: [
      {
        ...
        desc:
          '야생 동물의 지배자입니다. 다양한 야수를 길들여 함께 싸웁니다. 선호 무기: 활, 석궁, 총'
      },
      {
        name: 'survival',
        position: 'dealer',
      ...
      },
      {
        ...
        desc:
          '뛰어난 명사수입니다. 멀리 있는 적을 솜씨 좋게 처치합니다. 선호 무기: 활, 석궁, 총'
      }
    ]
  },
  {
    ...
    talents: [
      {
        ...
        desc:
          '원초적인 비전 마법을 부려 압도적인 힘으로 적을 파괴합니다. 선호 무기: 지팡이, 마법봉, 단검, 도검'
      },
      {
        name: 'fire',
        position: 'dealer',
    ...
    talents: [
      {
        ...
        desc:
          '교활한 술책으로 적과 맞서 싸우는 무자비한 도망자입니다. 선호 무기: 도끼, 둔기, 도검, 장착 무기'
      },
      {
        name: 'subtlety',
        position: 'dealer',
      ...
      },
      {
        ...
        desc:
          '치명적인 독극물의 대가입니다. 단검으로 잔인한 일격을 날려 적을 처치합니다. 선호 무기: 단검'
      }
    ]
  },
  {
    ...
    talents: [
      {
        ...
        desc:
          '자연과 정령의 파괴적인 힘을 자유자재로 이용하여 주문을 시전합니다. 선호 무기: 둔기, 단검, 방패'
      },
      {
        name: 'enhancement',
        position: 'dealer',
